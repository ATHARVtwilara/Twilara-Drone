# FlySky FS-i6 Based Camera Quadcopter

This repository documents the design and build of a quadcopter intended for stable flight and basic camera payload operation within a limited budget (approximately ₹12,400).

The objective of this project is to understand the complete drone system including mechanical structure, electronics, firmware configuration, wiring, and flight testing.
...
- Radio System: FlySky FS-i6 transmitter with FS-iA6 receiver
- Power System: 11.1V (3S) 2200mAh LiPo battery
...
- Configuration/ – Radio, ESC, and camera setup
